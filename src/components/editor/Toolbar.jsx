...
const Toolbar = ({
  ...
  const tools = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16.5 6.5l-9 9M21 21h-9.5" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.5 14.5l7-7 7 7-7 7-7-7z" />
        </svg>
      ),
      shortcut: 'E',
    },
    {
      ...
      name: 'Text',
      icon: (
        <span className="text-lg font-serif font-bold" style={{ fontFamily: 'Times New Roman, serif' }}>T</span>
      ),
      shortcut: 'T',
    },
  ];
